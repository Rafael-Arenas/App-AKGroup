#!/usr/bin/env python3
"""
Punto de entrada para ejecutar la aplicación completa de AK Group.

Ejecuta tanto el backend (FastAPI) como el frontend (Flet) simultáneamente.
...
if __name__ == "__main__":
    ...
    if not check_poetry_env():
        try:
            ...
            print()
            print("  1. Con Poetry:")
            print("     poetry run python run_app.py")
            print()
    ...
    # Importar y ejecutar el script que ejecuta ambos servicios
    try:
        from scripts.dev_all import main

        print("=" * 70)
        print("  AK GROUP - Full Application (Backend + Frontend)  ".center(70))
        print("=" * 70)
        print()
        main()
