#!/usr/bin/env python3
"""
Punto de entrada para ejecutar solo el frontend de AK Group.
...
if __name__ == "__main__":
    ...
    if not check_poetry_env():
        try:
            ...
            print()
            print("  1. Con Poetry:")
            print("     poetry run python run_frontend.py")
            print()
    ...
    # Importar y ejecutar el script de desarrollo del frontend
    try:
        from scripts.dev_frontend import main

        print("=" * 70)
        print("  AK GROUP - Frontend Desktop App  ".center(70))
        print("=" * 70)
        print()
        main()
